...
struct binary_buffer {
	 ...
	 *
	 * This is advanced by the `binary_buffer_next*` functions. It may also
	 * be modified directly so long as it remains less than or equal to @ref
	 * binary_buffer::end.
	 */
	const char *pos;
...
/**
 * Decode a ULEB128 number at the current buffer position and advance the
 * position.
 *
